...
const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "ClaimResponse", href: "/docs/resources/claim-response" },
      { title: "ChargeItem", href: "/docs/resources/charge-item" },
      { title: "ChargeItemDefinition", href: "/docs/resources/charge-item-definition" },
      { title: "Invoice", href: "/docs/resources/invoice" },
      { title: "PaymentNotice", href: "/docs/resources/payment-notice" },
      { title: "PaymentReconciliation", href: "/docs/resources/payment-reconciliation" },
      // Base R4 - Clinical
      { title: "AllergyIntolerance", href: "/docs/resources/allergy-intolerance" },
      { title: "Condition", href: "/docs/resources/condition" },
      { title: "DiagnosticReport", href: "/docs/resources/diagnostic-report" },
      { title: "MedicationAdministration", href: "/docs/resources/medication-administration" },
      { title: "MedicationRequest", href: "/docs/resources/medication-request" },
      { title: "NutritionOrder", href: "/docs/resources/nutrition-order" },
      { title: "PractitionerRole", href: "/docs/resources/practitioner-role" },
      // Reference

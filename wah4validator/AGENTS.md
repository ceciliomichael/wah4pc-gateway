...
<TASK>
The primary task is to create the backend system, which is a gateway for healthcare to connect them to each other, you may study the system for context, with FHIR validator
</TASK>
<development_flow>

...
import { buildAppointmentFromFormData } from '@/lib/fhir';
...
export default function CreateAppointmentPage() {
  ...
  async function handleSubmit(formData: AppointmentFormData) {
    ...
    try {
      ...
      const appointment = buildAppointmentFromFormData(formData, patient, practitioner);
      ...
      if (!res.ok) {
        ...
        throw new Error(errorData.issue?.[0]?.diagnostics || 'Failed to create appointment');
      }
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8">
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-slate-900">Create Appointment</h1>
        <p className="text-slate-500 mt-1">Schedule a new patient appointment</p>
      </div>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            <p className="text-slate-600 mb-4">
              You need at least one patient and one practitioner to create an appointment.
            </p>

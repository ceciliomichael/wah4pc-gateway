...
import { ProviderPractitionerMobileCard } from "@/components/practitioners/provider-practitioner-mobile-card";
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 md:hidden">
            {filteredProviders.map((provider) => (
              <ProviderPractitionerMobileCard
                key={provider.id}
                provider={provider}
              />
            ))}
